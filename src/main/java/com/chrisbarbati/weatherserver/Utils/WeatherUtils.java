...
public class WeatherUtils {
     ...
     *
     * Experimental. Unclear if this will provide any advantage over the linear regression, other
     * than being a bit more extensible because I can get the second derivative.
     *
     * @return The slope of the barometric pressure over the last hour.
     */
