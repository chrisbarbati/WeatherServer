...
/**
 * Component to hold utility methods for weather data.
 *
 * TODO: Experimental methods for the forecast function
 *
 * @since 1.0.0
...
public class WeatherUtils {
    ...
    /**
     * Construct an instance of {@link WeatherUtils}.
     * <p>
     ...
     * @author Christian Barbati
     */
    public WeatherUtils(DefaultWeatherService weatherService){
    ...
    public Double getBaroSlopeHourlyLinear(){
        ...
        LOGGER.debug("Hourly data size: " + hourlyData.size());
